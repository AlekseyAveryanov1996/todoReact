import style from "./Task.styl";

function Task({ value, removeTask, dataid, changedTask, status }) {
  return (
    <div className={status ? "task task_sacsess" : "task"}>
      <div
      ...
      <div className="task__value">{value}</div>
      <div
